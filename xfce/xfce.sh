...
if [ "$_notebook" == "s" ]; then # notebook
	...
	pacman -S xf86-input-synaptics xf86-input-libinput acpi acpid --noconfirm; sleep 1
...
curl -s -o /usr/share/pixmaps/arch-02.png 'https://raw.githubusercontent.com/leoarch/arch-linux/master/xfce/arch-02.png'
echo -e "[greeter]\nbackground=/usr/share/pixmaps/arch-02.png" > /etc/lightdm/lightdm-gtk-greeter.conf
